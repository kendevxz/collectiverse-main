...
puts "Creating 10 categories for you!"
user_category_1 = Category.new(name: "Transformers Studio Series")
...
user_category_1.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
user_category_1.save

user_category_2 = Category.create(name: "Marvel Legends")
...
user_category_2.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
user_category_2.save

user_category_3 = Category.create(name: "Star Wars Black Series")
...
user_category_3.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
user_category_3.save

user_category_4 = Category.create(name: "Power Rangers")
...
user_category_4.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
user_category_4.save

user_category_5 = Category.create(name: "Hot Toys")
...
user_category_5.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
user_category_5.save

user_category_6 = Category.create(name: "Mezco One:12")
file = URI.open("https://www.mezcotoyz.com/mas_assets/cache/image/1/6/e/2/x800-5858.Jpg")
user_category_6.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
user_category_6.save

user_category_7 = Category.create(name: "S.H. Figuarts")
...
user_category_7.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
user_category_7.save

user_category_8 = Category.create(name: "Hot Wheels")
file = URI.open("https://i.etsystatic.com/21588727/r/il/c3eb51/2704726143/il_fullxfull.2704726143_9jdz.jpg")
user_category_8.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
user_category_8.save

user_category_9 = Category.create(name: "Gundam")
...
user_category_9.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
user_category_9.save

user_category_10 = Category.create(name: "Mythic Legions")
file = URI.open("https://www.toyark.com/wp-content/uploads/2018/05/Mythic-Legions-MOTU-016.jpg")
user_category_10.photo.attach(io: file, filename: "nes.png", content_type: "image/png")
user_category_10.save

categories_list = [user_category_2, user_category_3, user_category_4, user_category_5, user_category_6, user_category_7, user_category_8, user_category_9, user_category_10]
